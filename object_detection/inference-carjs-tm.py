...
if __name__ == '__main__':
    ...
    #PATH_TO_CKPT = 'C:/AI/models/models/faster_rcnn_nas/faster_rcnn_nas_coco_2017_11_08/frozen_inference_graph.pb'
    #PATH_TO_LABELS = 'C:/AI/models/research/object_detection/data/mscoco_label_map.pbtxt'
